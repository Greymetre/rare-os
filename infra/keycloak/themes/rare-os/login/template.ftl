...
<div class="rare-auth-page">
<section class="rare-story" aria-label="RARE OS">
  <div class="rare-brand"><span class="rare-brand-mark">R</span><span>RARE <b>OS</b><small>by Greymetre</small></span></div>
  <div class="rare-story-copy"><span class="rare-eyebrow">YOUR OPERATIONS, CONNECTED</span>
    <h1>Clarity for every<br />working day.</h1>
    <p>Bring people, materials and production together in one workspace.</p>
    <div class="rare-levers"><span>Range</span><span class="active">Availability</span><span>Reach</span><span>Engagement</span></div>
  </div>
  <small>RARE OS · Operations workspace</small>
</section>
<main class="rare-auth-panel">
<div class="${properties.kcLoginClass!}">
    ...
    <div class="${properties.kcFormCardClass!}">
        <header class="${properties.kcFormHeaderClass!}">
            <span class="rare-eyebrow">LET’S GET TO WORK</span>
